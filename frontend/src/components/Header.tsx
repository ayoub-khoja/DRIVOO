  ...
  return (
    (!hidden && (
      <div style={classes.grow} className="header">
        <AppBar position="relative" sx={{ bgcolor: 'var(--drivoo-black)', boxShadow: 'none', borderBottom: '1px solid var(--drivoo-border)' }}>
          <Toolbar className="toolbar" variant="dense" disableGutters sx={{ px: 1, minHeight: { xs: 56, md: 60 } }}>
            {isLoaded && (
              <>
