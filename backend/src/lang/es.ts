...
export const es = {
  ...
  AGENCY_REQUEST_SUBJECT: 'Solicitud de socio DRIVOO recibida',
  AGENCY_REQUEST_TITLE: '¡Gracias por su solicitud!',
  AGENCY_REQUEST_BODY: 'Hemos recibido su solicitud para unirse a DRIVOO como agencia asociada. Nuestro equipo revisará su expediente.',
  AGENCY_REQUEST_NEXT: 'Recibirá otro correo cuando su cuenta sea aprobada, con un enlace para crear su contraseña y acceder a su espacio de agencia.',
  AGENCY_APPROVED_SUBJECT: 'Su agencia DRIVOO está aprobada — cree su contraseña',
  AGENCY_APPROVED_BODY: '¡Buenas noticias! Su solicitud de socio ha sido aprobada. Haga clic en el botón para crear su contraseña y completar su primer acceso.',
  AGENCY_APPROVED_CTA: 'Crear mi contraseña',
  SUB_AGENCY_INVITE_SUBJECT: 'Su espacio de subagencia DRIVOO',
  SUB_AGENCY_INVITE_BODY: 'Una agencia asociada le ha creado un espacio de subagencia. Haga clic abajo para definir su contraseña y acceder a su panel.',
  SUB_AGENCY_INVITE_CTA: 'Activar mi espacio',
  CLIENT_WELCOME_SUBJECT: `¡Bienvenido a ${env.WEBSITE_NAME}!`,
  CLIENT_WELCOME_TITLE: '¡Bienvenido!',
  CLIENT_WELCOME_BODY: `Su cuenta se ha creado correctamente. Ya puede iniciar sesión, descubrir vehículos y reservar su próximo alquiler con ${env.WEBSITE_NAME}.`,
  CLIENT_WELCOME_CTA: 'Iniciar sesión',
  ...
  FROM: 'De',
  MESSAGE: 'Mensaje',
  EMAIL_AUTO_MESSAGE: 'Este es un mensaje automático. Por favor, no responda.',
  EMAIL_NEED_HELP: '¿Necesita ayuda?',
  EMAIL_CONTACT_PROMPT: 'Si tiene preguntas o sugerencias, contáctenos en:',
  EMAIL_ADDRESS_LABEL: 'Dirección:',
  EMAIL_ALL_RIGHTS: 'Todos los derechos reservados.',
  ...
  AGENCY_REVIEW_NOTIFICATION: 'ha dejado una reseña (%{rating}/5) por validar.',
}
