...
export const en = {
  ...
  AGENCY_REQUEST_SUBJECT: 'DRIVOO partner application received',
  AGENCY_REQUEST_TITLE: 'Thank you for your application!',
  AGENCY_REQUEST_BODY: 'We have received your application to join DRIVOO as a partner agency. Our team will carefully review your file.',
  AGENCY_REQUEST_NEXT: 'You will receive another email once your account is approved, with a link to create your password and access your agency workspace.',
  AGENCY_APPROVED_SUBJECT: 'Your DRIVOO agency is approved — create your password',
  AGENCY_APPROVED_BODY: 'Great news! Your partner application has been approved. Click the button below to create your password and complete your first sign-in.',
  AGENCY_APPROVED_CTA: 'Create my password',
  SUB_AGENCY_INVITE_SUBJECT: 'Your DRIVOO sub-agency workspace',
  SUB_AGENCY_INVITE_BODY: 'A partner agency created a sub-agency workspace for you. Click below to set your password and access your cockpit.',
  SUB_AGENCY_INVITE_CTA: 'Activate my workspace',
  CLIENT_WELCOME_SUBJECT: `Welcome to ${env.WEBSITE_NAME}!`,
  CLIENT_WELCOME_TITLE: 'Welcome aboard!',
  CLIENT_WELCOME_BODY: `Your account has been created successfully. You can now sign in, browse vehicles and book your next rental with ${env.WEBSITE_NAME}.`,
  CLIENT_WELCOME_CTA: 'Sign in',
  ...
  FROM: 'From',
  MESSAGE: 'Message',
  EMAIL_AUTO_MESSAGE: 'This is an automated message. Please do not reply.',
  EMAIL_NEED_HELP: 'Need help?',
  EMAIL_CONTACT_PROMPT: 'If you have questions or suggestions, contact us at:',
  EMAIL_ADDRESS_LABEL: 'Address:',
  EMAIL_ALL_RIGHTS: 'All rights reserved.',
  ...
  AGENCY_REVIEW_NOTIFICATION: 'left a review (%{rating}/5) pending approval.',
}
