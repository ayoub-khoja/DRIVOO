...
export const fr = {
  ...
  AGENCY_REQUEST_SUBJECT: 'Demande partenaire DRIVOO reçue',
  AGENCY_REQUEST_TITLE: 'Merci pour votre candidature !',
  AGENCY_REQUEST_BODY: 'Nous avons bien reçu votre demande d’inscription en tant qu’agence partenaire. Notre équipe va étudier votre dossier avec attention.',
  AGENCY_REQUEST_NEXT: 'Vous recevrez un nouvel e-mail dès que votre compte sera approuvé, avec un lien pour créer votre mot de passe et accéder à votre espace agence.',
  AGENCY_APPROVED_SUBJECT: 'Votre agence DRIVOO est approuvée — créez votre mot de passe',
  AGENCY_APPROVED_BODY: 'Bonne nouvelle ! Votre dossier partenaire a été approuvé. Cliquez sur le bouton ci-dessous pour créer votre mot de passe et effectuer votre première connexion.',
  AGENCY_APPROVED_CTA: 'Créer mon mot de passe',
  SUB_AGENCY_INVITE_SUBJECT: 'Votre espace sous-agence DRIVOO',
  SUB_AGENCY_INVITE_BODY: 'Une agence partenaire vous a créé un espace sous-agence. Cliquez ci-dessous pour définir votre mot de passe et accéder à votre cockpit.',
  SUB_AGENCY_INVITE_CTA: 'Activer mon espace',
  CLIENT_WELCOME_SUBJECT: `Bienvenue sur ${env.WEBSITE_NAME} !`,
  CLIENT_WELCOME_TITLE: 'Bienvenue parmi nous !',
  CLIENT_WELCOME_BODY: `Votre compte a été créé avec succès. Vous pouvez dès maintenant vous connecter, découvrir les véhicules et réserver votre prochaine location avec ${env.WEBSITE_NAME}.`,
  CLIENT_WELCOME_CTA: 'Se connecter',
  ...
  FROM: 'De',
  MESSAGE: 'Message',
  EMAIL_AUTO_MESSAGE: 'Ceci est un message automatique. Merci de ne pas y répondre.',
  EMAIL_NEED_HELP: 'Besoin d’aide ?',
  EMAIL_CONTACT_PROMPT: 'Si vous avez des questions ou des suggestions, contactez-nous par e-mail à :',
  EMAIL_ADDRESS_LABEL: 'Adresse :',
  EMAIL_ALL_RIGHTS: 'Tous droits réservés.',
