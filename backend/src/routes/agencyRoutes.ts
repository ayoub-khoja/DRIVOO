...
routes.route(routeNames.getInvoiceXml).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getInvoiceXml)
routes.route(routeNames.getInvoicesRecap).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getInvoicesRecap)
routes.route(routeNames.getInvoicesRecapPdf).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getInvoicesRecapPdf)
...
routes.route(routeNames.getContractsRecap).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getContractsRecap)
routes.route(routeNames.getContractsRecapPdf).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getContractsRecapPdf)
...
routes.route(routeNames.getReceiptsRecap).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getReceiptsRecap)
routes.route(routeNames.getReceiptsRecapPdf).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getReceiptsRecapPdf)
...
routes.route(routeNames.getReceiptPdf).get(authJwt.verifyToken, authJwt.authSupplier, agencyController.getReceiptPdf)
