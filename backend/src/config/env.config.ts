...
/**
 * Agency (supplier portal) authentication cookie name.
 *
 * @type {"bc-x-access-token-agency"}
 */
export const AGENCY_AUTH_COOKIE_NAME = 'bc-x-access-token-agency'
...
/**
 * Header used to distinguish Admin panel vs Frontend when both share the same origin.
 *
 * @type {"x-bc-app"}
 */
export const X_APP_TYPE = 'x-bc-app'
...
/**
 * Supplier application documents (RNE, etc.) cdn folder path.
 *
 * @type {string}
 */
export const CDN_SUPPLIER_DOCS = __env__('BC_CDN_SUPPLIER_DOCS', true)

/**
 * Supplier application documents temp cdn folder path.
 *
 * @type {string}
 */
...
/**
 * Allowed supplier application document extensions (RNE scan, etc.).
 *
 * @type {string[]}
 */
export const allowedSupplierDocExtensions = [
  '.jpg',
  '.jpeg',
  '.png',
  '.webp',
