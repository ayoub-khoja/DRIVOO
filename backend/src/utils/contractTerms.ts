...
export const CONTRACT_TERMS_AR: ContractTermsArticle[] = [
  {
    ...
    paragraphs: [
      ...
      'لا يقود السيارة احد غيره اذا انه المتحصل الوحيد لمسؤوليتها و لا يجوز له ان يستعملها الا لقضاء حاجته كما لا يحق له حمل أكثر مما قدرته البطاقة الرمادية.',
      '- أن يحترم السرعة المحددة من قبل علامات المرور و ان لا يتجاوز في كل الحالات 110كلم/ساعة',
      '- أن لا يتجاوز300 كلم في اليوم كحد أدنى.',
  ...
  },
  {
    ...
    paragraphs: [
      'التأمين لا يصلح الا لمدة التسويغ و التمديد المصدق من طرف {{AGENCY}} المتسوغ مؤمن من الأخطاء التالية',
      '- مبلغ غير محدد للحوادث المرتكبة للغير أو للأشخاص الراكبين في السيارة بدون مقابل.',
      '- ضد الحريق السيارة الا اذا تبين خطا السائق.',
      '- ضد حوادث المرور مع اعفاء قدره 4 من ثمن شراء السيارة التي تبقى على كاهل المتسوغ.',
      'التأمين لا يشمل النقاط التالية:',
      '- اذا انقضت مدة الكراء و لم ترجع السيارة فان شركة {{AGENCY}} تتنحى عن المسؤولية في صورة وقوع حادث الا في حالة قبول تجديد مدة الكراء من طرف {{AGENCY}}.',
  ...
  },
  {
    ...
    paragraphs: [
      'اعلام {{AGENCY}} بالحادث في 24 ساعة كتابيا و اعلام الشرطة في الحين بكل حادث أو حريق أو تعويضها و يبقى العقد ساري المفعول مع زيادة 30 على سعر المتفق عليه باليوم حتى تسوية الوضعية و ارجاع السيارة الى حالتها الاصلية.',
      '- عند تحرير الاعلام يجب على المتسوغ أن يكتب أسباب وقوع الحادث التاريخ الساعة و مكان الحادث.',
      '- تضمن الوثائق المسلمة من طرف الشرطة و الحرس و العدول المنفذين اذ تحرر شيئا.',
  ...
  {
    title: 'المادة 4 : الوقود والبنزين',
    paragraphs: [
      'الوقود على كاهل المتسوغ و يجب أن يرجعه على نفس المستوى الذي استلمه عليه كما أن {{AGENCY}} لا تتحمل مسؤلية الوقود الزائد كما يجب أن يتفقد بالاستمرار الزيت و الماء.',
    ],
  },
  {
    title: 'المادة 5 : الصيانة والإصلاح',
    paragraphs: [
      ...
      '- لا تتحمل {{AGENCY}} المسؤولية في حادث ناتج عن خلل في صنع السيارة و اصلاح ابق لها.',
    ],
  },
  {
    title: 'المادة 6 : حالة السيارة',
    paragraphs: [
      'يستلم المتسوغ السيارة في حالة حسنة من ناحية النظافة و السير له الحق في الاعتراض أو التغيير بعد استلامه لها.',
  ...
  },
  {
    ...
    paragraphs: [
      'العقد لا يصلح الا للجولان داخل الجمهورية التونسية و يمنع عن الحرفاء مغادرة التراب التونسي بسيارة {{AGENCY}} منعا باتا إلا بإذن من الإدارة العامة التابعة لها و المصادقة من طرف السلطات المختصة.',
    ],
  },
  {
    title: 'المادة 8 : التسويغ، الرهن، التمديد',
    paragraphs: [
      '- الضمان لا يصلح لتمديد مدة التسويغ مهما كانت الحالة.',
      '- إذا اراد المتسوغ الاحتفاظ بالسيارة لمدة أطول ينبغي عليه أن يطلب موافقة {{AGENCY}} و ان يرسل معلوم الكراء المتفق عليه و إلا فإنه يتعرض الى تتبعات عدلية في اختلاس سيارة و خيانة مؤتمن و عدم خلاص.',
    ],
  },
  {
    title: 'المادة 9 : إرجاع السيارة',
    paragraphs: [
      '- إذا لم يقم المتسوغ بارجاع السيارة في الوقت المتفق عليه فان التسويغ يبقى قائم المفعول الى حدود ارجاعها مع زيادة 30 من سعر المتفق عليه في حالة عدم الاعلام.',
      '- في حالة تسليم السيارة في غير مكان الذي استلمها فيه فانه مطالب بدفع تكلفة 400 مليم على الكيلومتر الواحد من المسافة.',
    ],
  },
  {
    title: 'المادة 10 : وثائق السيارة',
    paragraphs: [
      '- على المتسوغ ارجاع السيارة اثر انهاء مدة التسويغ مصحوبة بجميع وثائقها (البطاقة الرمادية و الوثائق الرسمية...) و الا يبقى التسويغ سائر المفعول حتى ترجع الوثائق مع زيادة30.',
  ...
  },
  {
    ...
    paragraphs: [
      '- في حالة مخالفة الفصل1 النقطة "ب" فانه سيتم دفع 500 مليم على الكيلومتر الواحد بالنسبة الى المسافة المضافة.',
      '- يتحمل المتسوغ المسؤولية الكاملة في حالة مخالفته أي فصل من فصول هذا العقد.',
      '- المتسوغ يبقى المسؤول الوحيد على المخالفات و المحاضر التي تحرر من شانه.',
    ],
  },
  {
